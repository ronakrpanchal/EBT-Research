...
if IS_KAGGLE:
    ...
    OUTPUT_DIR = '/kaggle/working/output_5foldcv_v5_2stage'
    CACHE_DIR = '/kaggle/working/feat_cache_v5'
    ...
    OUTPUT_DIR = str(LIGHTNING_WORK_DIR / 'output_5foldcv_v5_2stage')
    CACHE_DIR = str(LIGHTNING_WORK_DIR / 'feat_cache_v5')
    ...
    OUTPUT_DIR = str(workspace / 'output_5foldcv_v5_2stage')
    CACHE_DIR = str(workspace / 'feat_cache_v5')
...
def main():
    ...
    print("╔══════════════════════════════════════════════════════════════╗")
    print("║  Bladder Classification — v5 5-Fold CV (2-STAGE FINETUNED)               ║")
    ...
    for fold_idx, fold_spec in enumerate(FIXED_FOLDS, start=1):
        ...
        global convnext_model, feat_dim
        feat_dim = load_backbones(fold_idx)
